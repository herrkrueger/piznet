"""NUTS Geographic Provider - Placeholder"""
import pandas as pd
from typing import Dict, Any
from ..base import DataProvider, DataProviderResult, DataProviderType, register_provider

@register_provider(DataProviderType.NUTS_GEO)
class NutsGeoProvider(DataProvider):
    def _get_provider_type(self) -> DataProviderType:
        return DataProviderType.NUTS_GEO
    ...
    def query(self, query_params: Dict[str, Any], **kwargs) -> DataProviderResult:
        return DataProviderResult(data=pd.DataFrame(), metadata={'provider': 'NUTS_GEO'}, status='no_data')